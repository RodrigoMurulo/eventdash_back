...
@Entity // indica que a clsse alarme é armazenavel no banco
@Table(name = "itmn=alarme") // especifica o nome da tabela
public class Alarme {

	@Column(name = "id_alarme") // indica o nome da coluna
